        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h3 class="font-weight-bolder text-info text-gradient">Eliminar Usuario</h3>
            </div>
                ...
                <li class="card-body pt-4 p-4 border-0 d-flex">
                  <div class="card-body pt-4 p-3">
                    <span class="mb-3 text-sm" id="basic-addon1">Cédula Usurio a buscar</span> <input
						...
						aria-describedby="mb-2 text-xs" required id="cedula_usuario"><br>
						
                    <button type="button" class="btn btn-primary" onclick="eliminar()">
					<i class="fas fa-search"></i> Eliminar usuario
					</button>
