...
<script>
		function enviar() {
				...
				req.open('GET', 'http://localhost:8080/consultarusuario?cedula='+user, false);
				req.send(null);
				var usuario = null;
				if (req.status == 200)
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Buscar Usuario</h6>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
    <div class="ms-auto text-end">
   		...
   		<a class="btn btn-link text-dark px-3 mb-0" href="listausuarios.jsp"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Listado usuario</a>		
   </div>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h3 class="font-weight-bolder text-info text-gradient">Buscar Usuario</h3>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="card-body pt-4 p-3">
              <div id="error" class="alert alert-danger visually-hidden"
				role="alert">Error al buscar el Usurio</div>
			...
			<div class="card-body pt-4 p-3">
              <ul class="list-group">
                <li class="card-body pt-4 p-4 border-0 d-flex">
                  <div class="card-body pt-4 p-3">
                    <span class="mb-3 text-sm" id="basic-addon1">Cédula Usurio a buscar</span> <input
						type="text" class="form-control"
						placeholder="  Inserte su cédula aquí"
						aria-describedby="mb-2 text-xs" required id="usersearch"><br>
                	...
                	<span class="p-1 text-sm" id="basic-addon2"> <h6>Cédula: </h6> </span> <input
						type="text" class="form-control"
						required id="cedula_usuario" disabled >
					
					<span class="mb-3 p-1 text-sm" id="mb-2 text-xs"><h6>Email: </h6> </span> <input
						type="text" class="form-control"
						required id="email_usuario" disabled >
						
					<span class="mb-3 p-1 text-sm" id="mb-2 text-xs"><h6>Nombre Completo: </h6></span> <input
						type="text" class="form-control"
						required id="nombre_usuario" disabled >
					
					<span class="mb-3 p-1 text-sm" id="mb-2 text-xs"><h6>Password: </h6> </span> <input
						type="text" class="form-control"
						required id="password" disabled >
