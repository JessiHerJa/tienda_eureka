...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Agregar Productos</h6>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
    <div class="ms-auto text-end">
   		<a class="btn btn-link text-dark text-gradient px-3 mb-0" href="insertarusuario.jsp"><i class="fas fa-pencil-alt text-dark me-2"></i>Agregar producto</a>	
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h3 class="font-weight-bolder text-info text-gradient">Agregar Productos</h3>
            </div>
 ...
 <input class="form-control" aria-describedby="mb-2 text-xs" required id="archivo" type="file" accept=".csv"><br>


                    <button type="button" class="btn btn-primary" onclick="subirArchivo()">
					<i class="fas fa-search"></i> Subir archivo
					</button>
