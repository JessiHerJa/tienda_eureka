    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Actualizar Usuario</h6>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
        ...
        <div class="col-12">
          <div class="card mb-4">
			...
			<div id="correcto" class="alert alert-success visually-hidden"
				role="alert">Usuario actualizado con éxito</div>
...
<div class="col-5">
		 <div class="text-center">
		   <button type="button" class="btn bg-gradient-info w-100 mt-4 mb-0" onclick="actualizar()">Actualizar usuario</button>
		 </div>
</div>
</div>
                  </form>
