        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h3 class="font-weight-bolder text-info text-gradient">Agregar Usuario</h3>
            </div>
...
<div class="col-5">
		 <div class="text-center">
		   <button type="button" class="btn bg-gradient-info w-100 mt-4 mb-0" onclick="enviar()">Insertar nuevo usuario</button>
		 </div>
</div>
</div>
                  </form>
